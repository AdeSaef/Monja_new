...
const MoreDetailReport = ({ data, closeMoreDetailReport }) => {
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-screen pb-20 flex z-50 bg-white overflow-hidden">
      {/* Bagian kiri: Gambar dan Detail */}
      <div className="flex-1 flex h-screen pb-20 flex-col z-50 overflow-y-scroll scrollbar-thin">
      ...
      <div className="w-1/3 flex justify-end">
        <div className="w-full h-auto">
          <div className="flex flex-col border-r-2 border-gray-300 mr-4 mt-2">
            <div className="text-end flex flex-wrap justify-end mb-2">
              <div
                className={`group ${
                  onDetail
                ...
                onClick={openDetail}
              >
                <div className="group-hover:bg-gray-300 group-hover:text-white pl-4 pr-2 text-xl font-semibold select-none cursor-pointer">
                  Detail
                </div>
              </div>
            </div>
            <div className="text-end flex flex-wrap justify-end my-2">
              <div
                className={`group ${
                  onKekerasan
                    ? "bg-gray-300 text-white"
