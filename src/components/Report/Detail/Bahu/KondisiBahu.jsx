...
export const KondisiBahu = ({ data, onBahu }) => {
  ...
  useEffect(() => {
    ...
    setKiri(
      KBahuKiri[moreData.SHOULDER_CHANNEL_SIDE.LEFT_SHOULDER_CONDITION] || 1
    );
    const KBahuKanan = {
      "Tidak ada": 1,
      "Baik/Rata": 2,
    ...
    setKiri(
      KBahuKanan[moreData.SHOULDER_CHANNEL_SIDE.RIGHT_SHOULDER_CONDITION] || 1
    );
  }, [moreData]);
