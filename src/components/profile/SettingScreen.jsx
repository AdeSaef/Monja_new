...
const SettingScreen = ({ isSetting }) => {
  ...
  return (
    ...
    >
      ...
      <div className="border border-white border-x-0 border-t-0 p-1 text-white hover:bg-gray-600 select-none" onClick={updatePassword}>
        Ubah Password
      </div>
      <div className="flex justify-end p-1">
        <button className="bg-red-700 rounded-lg px-2 text-white">Keluar</button>
      </div>
    </div>
  );
};
